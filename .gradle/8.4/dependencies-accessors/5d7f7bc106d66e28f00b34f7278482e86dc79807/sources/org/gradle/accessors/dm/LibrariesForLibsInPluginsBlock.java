...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    public static class SupportLibraryAccessors extends SubDependencyFactory {
        private final SupportAppcompatLibraryAccessors laccForSupportAppcompatLibraryAccessors = new SupportAppcompatLibraryAccessors(owner);

        public SupportLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Returns the group of libraries at support.appcompat
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public SupportAppcompatLibraryAccessors getAppcompat() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForSupportAppcompatLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class SupportAppcompatLibraryAccessors extends SubDependencyFactory {

        public SupportAppcompatLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
        ...
        @Deprecated
            ...
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
                return create("support.appcompat.v7");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        public VersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: appcompatV7Version (X.X.X)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getAppcompatV7Version() { return getVersion("appcompatV7Version"); }
