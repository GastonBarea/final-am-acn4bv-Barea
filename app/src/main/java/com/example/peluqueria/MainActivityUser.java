    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(MainActivityUser.this, MainActivityHome.class);
        ...
        btn_books.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MainActivityUser.this, MainActivityBook.class);
                startActivities(new Intent[]{intent});
            }
        });
        ...
        btn_history.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MainActivityUser.this, MainActivityHistory.class);
                startActivities(new Intent[]{intent});
            }
        });
