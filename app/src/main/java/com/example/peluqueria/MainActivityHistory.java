...
public class MainActivityHistory extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.history_page), (v, insets) -> {
        ...
        btn_home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(MainActivityHistory.this, MainActivityHome.class);
        ...
        btn_books.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MainActivityHistory.this, MainActivityBook.class);
                startActivities(new Intent[]{intent});
            }
        });
        ...
        btn_user.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MainActivityHistory.this, MainActivityUser.class);
                startActivities(new Intent[]{intent});
            }
        });
        ...
        btn_history.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MainActivityHistory.this, MainActivityHistory.class);
                startActivities(new Intent[]{intent});
            }
        });
